var GOT={
    currentControlName:"trackball", //trackball,pointerlock,daydream,cardboard
    ...
    jsonModels:{
        path:"models/",
        type:".json",
        arr:["m1","m2","m3","m4","m5","m6","m7","m8","m9","m10","m11","m12","m13","m14","m14","m17"],
        //需要异步操作的模型
        arrPromise:[]
    },
    ...
    view1: {position:new THREE.Vector3(0,1600,0),name:"客厅",index:1},
    ...
    //提示信息
    signLength:4,
    sign0: {name:"sign0",infoTextName:"infoText0",position:new THREE.Vector3(0,1000,0)},
